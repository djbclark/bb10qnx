...
extern void *lfind(const void *__key, const void *__base, _CSTD size_t *__num, _CSTD size_t __width, int (* __compare)(const void *, const void *));
extern void *lsearch(const void *__key, void *__base, _CSTD size_t *__num, _CSTD size_t __width, int (* __compare)(const void *, const void *));
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/deckard/BB10_2_0X/lib/c/public/search.h $ $REV$")
#endif
