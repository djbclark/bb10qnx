...
#ifdef _STD_USING
# ifdef errno
using _CSTD __get_errno_ptr;
# else
using _CSTD errno; using _CSTD errno_t;
# endif
#endif /* _STD_USING */
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/deckard/BB10_2_0X/lib/c/public/errno.h $ $REV$")
#endif
