...
typedef struct xscale_cp0 {
	unsigned	acc0_lo;
	unsigned	acc0_hi;
} XSCALE_CP0_REGISTERS;

typedef struct arm_wmmx_registers {
	_Uint64t	wr[16];
	_Uint32t	wcssf;
	_Uint32t	wcasf;
	_Uint32t	wcgr0;
...
__SRCVERSION( "$URL: http://svn.ott.qnx.com/product/branches/deckard/BB10_2_0X/services/system/public/arm/context.h $ $Rev: 290671 $" )
