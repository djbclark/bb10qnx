...
/*
 * _mux_smp_cmpxchg() and _mux_smp_xchg() are  used only for mutexes
 */
extern unsigned	_mux_smp_cmpxchg(volatile unsigned *__dst, unsigned __cmp, unsigned __src);
extern unsigned _mux_smp_xchg(volatile unsigned *__dst, unsigned __src);

#define __mutex_smp_cmpxchg(d, c, s)	_mux_smp_cmpxchg((d), (c), (s))
#define __mutex_smp_xchg(d, s)			_mux_smp_xchg((d), (s))
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/deckard/BB10_2_0X/lib/c/public/arm/smpxchg.h $ $REV$")
#endif
