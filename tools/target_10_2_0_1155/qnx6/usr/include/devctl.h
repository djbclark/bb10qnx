...
extern int get_device_size(int command);
...
#define get_device_size(_cmd)				(((_cmd) & ~DEVDIR_TOFROM) >> 16)
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/deckard/BB10_2_0X/lib/c/public/devctl.h $ $REV$")
#endif
