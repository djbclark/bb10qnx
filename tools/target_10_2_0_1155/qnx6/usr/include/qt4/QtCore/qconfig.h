...
# ifdef __ARM__
#  define QT_ARCH_ARM
#  define QT_BUILD_KEY "arm blackberry qcc no-pkg-config"
# elif defined __X86__
#  define QT_ARCH_GENERIC
#  define QT_BUILD_KEY "generic blackberry qcc no-pkg-config"
# endif
#else
# define QT_ARCH_I386
#endif
...
#if defined(QT_POSIX_IPC) && defined(QT_NO_POSIX_IPC)
# undef QT_POSIX_IPC
#elif !defined(QT_POSIX_IPC) && !defined(QT_NO_POSIX_IPC)
# define QT_POSIX_IPC
#endif
