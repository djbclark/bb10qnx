...
/* GL_EXT_texture_compression_fujitsu */
#ifndef GL_EXT_texture_compression_fujitsu
#define GL_COMPRESSED_RGBA_5_5_5_1_FUJITSU_EXT                  0x8E94
#define GL_COMPRESSED_RGBA_FUJITSU_EXT                          0x8E95
#endif
...
/*------------------------------------------------------------------------*
 * QNX extension tokens
 *------------------------------------------------------------------------*/

/* GL_QNX_texture_tiling */
#ifndef GL_QNX_texture_tiling
#define	GL_TEXTURE_TILING_QNX                                   0x8E91
#endif

/* GL_QNX_line_stipple */
#ifndef GL_QNX_line_stipple
#define	GL_LINE_STIPPLE                                         0x0B24
#define	GL_LINE_RECTANGULAR_SEGMENTS_QNX                        0x8E92
#define	GL_LINE_STIPPLE_MONO_QNX                                0x8E93
#endif
...
/* GL_EXT_texture_compression_fujitsu */
#ifndef GL_EXT_texture_compression_fujitsu
#define GL_EXT_texture_compression_fujitsu 1
#endif
...
/*------------------------------------------------------------------------*
 * QNX extension functions
 *------------------------------------------------------------------------*/

/* GL_QNX_texture_tiling */
#ifndef GL_QNX_texture_tiling
#define GL_QNX_texture_tiling 1
#endif

/* GL_QNX_line_stipple */
#ifndef GL_QNX_line_stipple
#define GL_QNX_line_stipple 1
#ifdef GL_GLEXT_PROTOTYPES
GL_API void GL_APIENTRY glLineStipplePatternQNX (GLushort pattern);
GL_API void GL_APIENTRY glBackColor4fQNX (GLfloat red, GLfloat green, GLfloat blue, GLfloat alpha);
GL_API void GL_APIENTRY glBackColor4xQNX (GLfixed red, GLfixed green, GLfixed blue, GLfixed alpha);
#endif
typedef void(GL_APIENTRYP PFNGLLINESTIPPLEPATTERNQNXPROC) (GLushort pattern);
typedef void(GL_APIENTRYP PFNGLBACKCOLOR4FQNXPROC) (GLfloat red, GLfloat green, GLfloat blue, GLfloat alpha);
typedef void(GL_APIENTRYP PFNGLBACKCOLOR4XQNXPROC) (GLfixed red, GLfixed green, GLfixed blue, GLfixed alpha);
#endif

/* GL_QNX_discard_buffers */
#ifndef GL_QNX_discard_buffers
#define GL_QNX_discard_buffers 1
#ifdef GL_GLEXT_PROTOTYPES
GL_API void GL_APIENTRY glDiscardBuffers (GLbitfield mask);
#endif
typedef void(GL_APIENTRYP PFNGLDISCARDBUFFERSQNXPROC) (GLbitfield mask);
#endif
