 ...
 *
 * @details The prompt displayed will be an application-modal window, though it is possible to use a system-modal window by setting
...
class BB_SYSTEM_EXPORT SystemPrompt : public QObject
{
    ...
    /*!
     * @brief Indicates whether a toggle switch for remembering user selection and input should be included in the prompt.
     ...
     * @note -1 implies that the default system behavior will be applied. The supported range is 1-3, with any values outside the range resetting the property to its default value.
     *
     * @since BlackBerry 10.0.0
     */
     ...
     * @details If @c false, the prompt must be dismissed using @c cancel(). Otherwise, the prompt is dismissed with a button selection.
     *
     * This is a presentation property whose default value is @c true.
     *
     * @since BlackBerry 10.0.0
    ...
    /*!
     * @brief Represents the input field that will be included in the prompt.
     * @details The label property of the field will be ignored.
     *
     * @since BlackBerry 10.0.0
     *
     * @xmlonly
     ...
     *
<<<<<<< HEAD
     * @details This is a presentation property whose default value is @c
     * bb::system::SystemUiInputOption::AutoCorrect | bb::system::SystemUiInputOption::SpellCheck | bb::system::SystemUiInputOption::AutoCapitalize.
=======
...
>>>>>>> Dialog refactoring
     ...
     * If the @c defaultButton is @c NULL, then triggering the return key action will not select a button.
     *
...
public:
    ...
    /*!
     * @brief Destroys the prompt, canceling any pending requests.
     *
     * @since BlackBerry 10.0.0
     */
    ...
    /*!
     * @brief Retrieves the flag indicating if a toggle switch to remember user selection and input should be included in the prompt.
     * @return @c true if a toggle for remembering the user selection should be included in the prompt, @c false otherwise.
     *
     * @since BlackBerry 10.0.0
     */
    ...
    /*!
     * @brief Sets the flag indicating if a toggle switch for remembering user selection should be included in the prompt.
    ...
    /*!
     * @brief Sets the options for the dialog's @c inputField.
    ...
    /*!
     * @brief Resets the flag to show the toggle for remembering user selection and input to @c false.
     ...
     * @details All properties of the input field will be reset.
     *
     * @since BlackBerry 10.0.0
     */
    ...
    /*!
     * @brief Resets the @c inputOptions of the dialog's @c inputField.
<<<<<<< HEAD
     * @details The @c inputOptions property is set to @c
     * bb::system::SystemUiInputOption::AutoCorrect | bb::system::SystemUiInputOption::SpellCheck | bb::system::SystemUiInputOption::AutoCapitalize.
=======
...
>>>>>>> Dialog refactoring
    ...
    /*!
     * @brief Returns the state of the toggle for remembering user selection and input when the user dismisses the prompt.
     *
...
public Q_SLOTS:
     ...
     * @details The result of the request can be retrieved with the @c result property or via the signal @c finished().
     ...
     * @details The result of the request can be retrieved with the @c SystemPrompt::result property, or using the signal @c finished().
     * The text can be retrieved with the @c inputFieldTextEntry() method.
     * The button selection can be retrieved with the @c buttonSelection() method.
     *
...
Q_SIGNALS:
     ...
     * The state of the toggle for remembering the content of this prompt can be retrieved using @c rememberMeSelection().
...
//!@cond PRIVATE
     ...
     * @xmlonly
     * <qml>
     * <param name="newOptions" type="bb::system::SystemUiInputOption::Types"/>
     * </qml>
     * @endxmlonly
     */
