...
struct utimbuf {
    _CSTD time_t      actime;         /* access time */
    _CSTD time_t      modtime;        /* modification time */
};
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/deckard/BB10_2_0X/lib/c/public/utime.h $ $REV$")
#endif
