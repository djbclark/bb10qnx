...
#define RESMGR_FLAG_ATTACH_OTHERFUNC	0x00000004	/* other_func member is called for unhandled I/O messages */
#define RESMGR_FLAG_CROSS_ENDIAN		0x00000008	/* Server handles cross-endian support */
#define RESMGR_FLAG_RCM					0x00000010	/* Server handles resource constraint mode */
...
typedef struct _resmgr_attr {
	...
	unsigned					msg_max_size;	/* Minimum amount of room to reserve for receiving a message */
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/deckard/BB10_2_0X/lib/c/public/sys/dispatch.h $ $REV$")
#endif
