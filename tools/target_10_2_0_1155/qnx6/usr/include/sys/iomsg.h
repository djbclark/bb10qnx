...
struct _io_resmgr_link_extra {
	...
	_Int32t								chid;
	_Uint32t							handle;
	_Uint32t							flags;			/* Members from the PATHMGR_FLAG_xxx set */
	_Uint32t							file_type;		/* Value from the _FTYPE_xxx set */
	_Uint32t							reserved[2];
};
...
typedef union _io_link_extra {
	...
	__FLEXARY(char, path);							/* EXTRA_SYMLINK */
} io_link_extra_t;
...
*/
#define _IO_DEVCTL_VERIFY_LEN     		0x00000001UL  /* Deprecated - The encoded length should match the message .nbytes field 
                             		                    .nbytes could be wrong - Use instead _IO_DEVCTL_VERIFY_MSG_LEN */
#define _IO_DEVCTL_VERIFY_DIR     		0x00000002UL  /* The ioflags should match the encoded direction value */
#define _IO_DEVCTL_VERIFY_PRIV    		0x00000004UL  /* Only privileged users can perform this devctl */
#define _IO_DEVCTL_VERIFY_OCB_READ		0x00000008UL  /* OCB must have read access */
#define _IO_DEVCTL_VERIFY_OCB_WRITE		0x00000010UL  /* OCB must have write access */
#define _IO_DEVCTL_VERIFY_ACC_ISUID		0x00000020UL  /* effective user ID must matches ocb->attr->uid */
#define _IO_DEVCTL_VERIFY_ACC_ISGID		0x00000040UL  /* effective group ID or supplementary group IDs matches ocb->attr->gid */
#define _IO_DEVCTL_VERIFY_ACC_IREAD		0x00000080UL  /* must have READ access specified by ocb->attr->mode */
#define _IO_DEVCTL_VERIFY_ACC_IWRITE	0x00000100UL  /* must have WRITE access specified by ocb->attr->mode */
#define _IO_DEVCTL_VERIFY_ACC_IEXEC		0x00000200UL  /* must have EXEC access specified by ocb->attr->mode */
#define _IO_DEVCTL_VERIFY_MSG_LEN  		0x00000400UL  /* must have received enough data to cover the encoded length  */
...
*/
#define _IO_DEVCTL_VERIFY_ACC_MASK		0x000003E0UL  /* mask of all _IO_DEVCTL_VERIFY_ACC_xxx bits */
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/deckard/BB10_2_0X/lib/c/public/sys/iomsg.h $ $REV$")
#endif
