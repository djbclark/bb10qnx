...
#define UNMAP_CLEAN 		0x00000004
#define UNMAP_NOCLEAN		0x00000008
...
extern int getpagesizes(_CSTD size_t __pagesize[], int __nelem);
...
#ifdef __EXT_LF64SRC
extern void *mmap64(void *__addr, _CSTD size_t __len, int __prot, int __flags, int __fd, off64_t __off) __ALIASOFF("mmap");
#if defined(__EXT_LF64ALIAS) && !defined(__ALIAS_ATTRIBUTE)
#error ALIAS not configured for compiler: mmap
#endif
#endif
extern void *mmap(void *__addr, _CSTD size_t __len, int __prot, int __flags, int __fd, off_t __off) __ALIAS64("mmap64");
...
#ifdef __EXT_LF64SRC
extern int posix_mem_offset64(__const void *__addr, _CSTD size_t __len, off64_t *__off, _CSTD size_t *__contig_len, int *__fd) __ALIASOFF("posix_mem_offset");
#if defined(__EXT_LF64ALIAS) && !defined(__ALIAS_ATTRIBUTE)
#error ALIAS not configured for compiler: posix_mem_offset
#endif
#endif

extern int posix_mem_offset(__const void *__addr, _CSTD size_t __len, off_t *__off, _CSTD size_t *__contig_len, int *__fd) __ALIAS64("posix_mem_offset64");
...
#ifdef __EXT_LF64SRC
extern int mem_offset64(__const void *__addr, int __fd, _CSTD size_t __len, off64_t *__off, _CSTD size_t *__contig_len) __ALIASOFF("mem_offset");
#if defined(__EXT_LF64ALIAS) && !defined(__ALIAS_ATTRIBUTE)
#error ALIAS not configured for compiler: mmap
#endif
#endif

extern int mem_offset(__const void *__addr, int __fd, _CSTD size_t __len, off_t *__off, _CSTD size_t *__contig_len) __ALIAS64("mem_offset64");
#ifdef __EXT_FUNCALIAS64
#ifdef __ALIAS_ATTRIBUTE
/* Use the __ALIAS64 define */
#else
...
extern int shm_ctl_stride(int __fd, int __flags, _Uint64t __physical, _Uint64t __size, unsigned sstride, unsigned dstride);
extern int shm_ctl_special_stride(int __fd, int __flags, _Uint64t __physical, _Uint64t __size, unsigned __special, unsigned sstride, unsigned dstride);
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/deckard/BB10_2_0X/lib/c/public/sys/mman.h $ $REV$")
#endif
