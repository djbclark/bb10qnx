...
#define _DEBUG_FLAG_EXEC			0x00080000	/* Stop on exec. */
#define _DEBUG_FLAG_MASK			0x000f0000	/* Flags that can be changed */
#define _DEBUG_FLAG_THREAD_EV		0x00100000	/* Stop on thread create/destroy */
...
#define _DEBUG_RUN_THREAD			0x00000400	/* Debugger is interested in thread created/destroyed events */
#define _DEBUG_RUN_CHILD			0x00000800	/* Deliver event when process does spawn, fork vfork. */
#define _DEBUG_RUN_EXEC				0x00001000	/* Deliver event when process does exec. */
...
__SRCVERSION( "$URL: http://svn.ott.qnx.com/product/branches/deckard/BB10_2_0X/services/system/public/sys/debug.h $ $Rev: 688798 $" )
