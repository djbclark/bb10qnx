...
extern int   traceparser_one_event(struct traceparser_state *tps_p, traceevent_t* t_e_p);
...
__SRCVERSION( "$URL: http://svn.ott.qnx.com/product/branches/deckard/BB10_2_0X/lib/traceparser/public/sys/traceparser.h $ $Rev: 221011 $" )
#endif
