...
#define DCMD_MISC_GETPTREMBED           __DIOTF(_DCMD_MISC, 3, struct __ioctl_getptrembed)
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/deckard/BB10_2_0X/lib/c/public/sys/dcmd_misc.h $ $REV$")
#endif
