...
#error ALIAS not configured for compiler: stat,lstat,fstat
#endif
#endif
...
extern int _mknod_extra(const char *__path, _CSTD mode_t __mode, _CSTD dev_t __dev, unsigned __extra_type, unsigned __extra_len, void *__extra);
...
#ifdef _STD_USING
using _CSTD mode_t; using _CSTD dev_t; using _CSTD time_t;
#endif
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/deckard/BB10_2_0X/lib/c/public/sys/stat.h $ $REV$")
#endif
