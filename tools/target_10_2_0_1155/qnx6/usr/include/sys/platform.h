...
*   QNX6.5 and earlier defaulted to 32-bit offsets and exposed func64() functions.
    Defining _FILE_OFFSET_SMALL will get 32-bit offsets in a 32-bit program,
    and 64-bit offsets in a 64-bit program.
...
In library functions (usually #define _LARGEFILE64_SOURCE and _FILE_OFFSET_SMALL before including anything)
