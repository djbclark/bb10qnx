...
#define _RESMGR_NOREPLY			((~0U ^ (~0U >> 1)) | 0U)	/* Do not reply to sender (could use _RESMGR_AGAIN later) */
#define _RESMGR_DEFAULT			((~0U ^ (~0U >> 1)) | 1U)	/* Default action (usually return ENOSYS) */
...
#define _RESMGR_PULSE_ALLOC			~0U			/* passed as code to qnx_resmgr_pulse() */
...
extern int resmgr_pause(resmgr_context_t *__ctp);
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/deckard/BB10_2_0X/lib/c/public/sys/resmgr.h $ $REV$")
#endif
