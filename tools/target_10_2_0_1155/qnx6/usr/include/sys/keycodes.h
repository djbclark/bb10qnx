...
#define KEYCODE_AC_REPLY                                        (KEYCODE_CONSUMER_KEYS + 0x46)
#define KEYCODE_AC_FORWARD_MSG                                  (KEYCODE_CONSUMER_KEYS + 0x47)
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/deckard/BB10_2_0X/lib/ph/public/sys/keycodes.h $ $REV$")
#endif
