...
struct callin_entry {
	...
	_SPFPTR(void, quiesce_cpus, (int));
	_SPFPTR(void, spare[10],);
};
...
__SRCVERSION( "$URL: http://svn.ott.qnx.com/product/branches/deckard/BB10_2_0X/services/system/public/sys/syspage.h $ $Rev: 637073 $" )
#endif
