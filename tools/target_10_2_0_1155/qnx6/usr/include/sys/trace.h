...
#define _NTO_TRACE_SYS_DEFRAG_START	(0x0000000d)
#define _NTO_TRACE_SYS_RUNSTATE     (0x0000000e)
#define _NTO_TRACE_SYS_POWER		(0x0000000f)
#define _NTO_TRACE_SYS_IPI			(0x00000010)
#define _NTO_TRACE_SYS_PAGEWAIT		(0x00000011)
#define _NTO_TRACE_SYS_TIMER		(0x00000012)
#define _NTO_TRACE_SYS_DEFRAG_END	(0x00000013)
#define _NTO_TRACE_SYS_LAST			_NTO_TRACE_SYS_DEFRAG_END
...
#define _TRACE_QUIP_C               (0x00000008<<10)
#define _TRACE_TOT_CLASS_NUM        (9)
...
#define trace_here() (TraceEvent( _NTO_TRACE_INSERTSCLASSEVENT, _TRACE_SYSTEM_C >> 10, _NTO_TRACE_SYS_ADDRESS, _trace_getpc(), (unsigned)0 ))
#else
static __inline__ int trace_here( void )
{
	void * const pc = __builtin_return_address(0);
	return TraceEvent( _NTO_TRACE_INSERTSCLASSEVENT, _TRACE_SYSTEM_C >> 10, _NTO_TRACE_SYS_ADDRESS, (unsigned)pc, (unsigned)0 );
}
#endif
...
__SRCVERSION( "$URL: http://svn.ott.qnx.com/product/branches/deckard/BB10_2_0X/services/system/public/sys/trace.h $ $Rev: 674828 $" )
#endif
