 ...
 * 
 */
/* $Id: humd4.h 39908 2010-02-18 20:19:44Z korr $
 * $Source$
 * $Name$
 */
#ifndef HUMD4_H
...
@param[in] hashContext  An MD4 context object.
...
@param[in,out] hashContext  The MD4 context object pointer.
...
created after a call to <tt>hu_MD4Begin()</tt>.

@param[in] hashContext  The MD4 context object.
@param[in] sbCtx        A global context.
...
This function can be used to compute the digest of multiple items of data with 
identical prefixes.

@param[in]  hashContext     The original MD4 context object.
@param[out] newHashContext  The target MD4 context object pointer.
@param[in]  sbCtx           A global context.
