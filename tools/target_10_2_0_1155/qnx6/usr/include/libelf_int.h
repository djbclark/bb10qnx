...
int Elf32_swapNhdr( Elf *elf, Elf32_Nhdr *nhdr );
...
__SRCVERSION( "$URL: http://svn.ott.qnx.com/product/branches/deckard/BB10_2_0X/lib/elf/public/libelf_int.h $ $Rev: 711699 $" )
#endif
