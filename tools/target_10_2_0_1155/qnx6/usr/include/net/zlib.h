...
#ifndef _NET_ZLIB_H_INCLUDED
#define _NET_ZLIB_H_INCLUDED
...
/* @(#) $Id: zlib.h 152567 2007-08-30 17:35:56Z seanb $ */
...
#if (defined(HAVE_UNISTD_H) || defined(__NetBSD__) || defined(__QNXNTO__)) && !defined(_KERNEL)
...
#endif /* !_NET_ZLIB_H_INCLUDED */
/* -- zlib.h */

__SRCVERSION( "$URL: http://svn.ott.qnx.com/product/branches/deckard/BB10_2_0X/lib/socket/public/net/zlib.h $ $Rev: 233581 $" )
