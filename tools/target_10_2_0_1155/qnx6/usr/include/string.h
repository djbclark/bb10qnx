...
extern _CSTD errno_t memset_s(void *v, _CSTD rsize_t smax, int c, _CSTD rsize_t n);
...
# endif
using _CSTD size_t; using _CSTD rsize_t; using _CSTD errno_t;
using _CSTD memchr; using _CSTD memmove; using _CSTD memset;
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/deckard/BB10_2_0X/lib/c/public/string.h $ $REV$")
#endif
