...
#define X86_FEATURE_CFLUSH		(1UL << 19)
#define X86_FEATURE_DS			(1UL << 21)
#define X86_FEATURE_ACPI		(1UL << 22)
#define X86_FEATURE_MMX			(1UL << 23)
#define X86_FEATURE_FXSR		(1UL << 24)
#define X86_FEATURE_SIMD		(1UL << 25)
#define X86_FEATURE_SSE2		(1UL << 26)
#define X86_FEATURE_SS			(1UL << 27)
#define X86_FEATURE_HTT			(1UL << 28)
#define X86_FEATURE_TM			(1UL << 29)
#define X86_FEATURE_PBE			(1UL << 31)
/*ECX register */
#define X86_FEATURE2_SSE3		(1UL << 0)
#define X86_FEATURE2_PCLMULQDQ	(1UL << 1)
#define X86_FEATURE2_DTES64		(1UL << 2)
#define X86_FEATURE2_MONITOR	(1UL << 3)
#define X86_FEATURE2_DS_CPL		(1UL << 4)
#define X86_FEATURE2_VMX		(1UL << 5)
#define X86_FEATURE2_SMX		(1UL << 6)
#define X86_FEATURE2_EIST		(1UL << 7)
#define X86_FEATURE2_TM2		(1UL << 8)
#define X86_FEATURE2_SSSE3		(1UL << 9)
#define X86_FEATURE2_CNXT_ID	(1UL << 10)
#define X86_FEATURE2_FMA		(1UL << 12)
#define X86_FEATURE2_CMPXCHG16B	(1UL << 13)
#define X86_FEATURE2_xTPR_UPDATE_CONTROL	(1UL << 14)
#define X86_FEATURE2_PDCM		(1UL << 15)
#define X86_FEATURE2_PCID		(1UL << 17)
#define X86_FEATURE2_DCA		(1UL << 18)
#define X86_FEATURE2_SSE4_1		(1UL << 19)
#define X86_FEATURE2_SSE4_2		(1UL << 20)
#define X86_FEATURE2_x2APIC		(1UL << 21)
#define X86_FEATURE2_MOVBEA		(1UL << 22)
#define X86_FEATURE2_POPCNT		(1UL << 23)
#define X86_FEATURE2_TSC_DEADLINE	(1UL << 24)
#define X86_FEATURE2_AESNI		(1UL << 25)
#define X86_FEATURE2_XSAVE		(1UL << 26)
#define X86_FEATURE2_OSXSAVE	(1UL << 27)
#define X86_FEATURE2_AVX		(1UL << 28)
#define X86_FEATURE2_RDRAND		(1UL << 29)
...
__SRCVERSION( "$URL: http://svn.ott.qnx.com/product/branches/deckard/BB10_2_0X/services/system/public/x86/cpu.h $ $Rev: 605286 $" )
#endif
