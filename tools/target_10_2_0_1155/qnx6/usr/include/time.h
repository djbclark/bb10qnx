...
# define timespec2nsec(__ts) ((__ts)->tv_sec*(_Uint64t)1000000000+(_Uint64t)(_Int64t)(__ts)->tv_nsec)
...
extern _CSTD time_t timegm (struct _CSTD tm *__tp);
#endif
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/deckard/BB10_2_0X/lib/c/public/time.h $ $REV$")
#endif
