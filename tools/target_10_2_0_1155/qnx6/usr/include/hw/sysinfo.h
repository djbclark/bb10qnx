...
#define HWI_TAG_NAME_diskpartition	"diskpartition"
#define HWI_TAG_ALIGN_diskpartition	(sizeof(_Uint64t))
struct hwi_diskpartition {
	struct hwi_prefix	prefix;
	_Uint8t				part_flags;
	_Uint8t				part_num;
	_Uint16t			part_name;
...
#define HWI_TAG_NAME_hwversion		"hwversion"
#define HWI_TAG_ALIGN_hwversion		(sizeof(_Uint32t))
struct hwi_hwversion {
	struct hwi_prefix	prefix;
	_Uint8t				hclass;
	_Uint8t				version;
	_Uint16t			name;
...
typedef union {
	...
	struct hwi_diskpartition 	diskpartition;
	...
	struct hwi_hwversion		hwversion;
} hwi_tag;
...
__SRCVERSION( "$URL: http://svn.ott.qnx.com/product/branches/deckard/BB10_2_0X/services/system/public/hw/sysinfo.h $ $Rev: 644013 $" )
