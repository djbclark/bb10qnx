...
extern _CSTD ssize_t pread64(int __filedes, void *__buff, _CSTD size_t __nbytes, off64_t __offset) __ALIASOFF("pread");
extern _CSTD ssize_t pwrite64(int __filedes, const void *__buff, _CSTD size_t __nbytes, off64_t __offset) __ALIASOFF("pwrite");
# if defined(__EXT_QNX)
extern off64_t tell64(int __fildes) __ALIASOFF("tell");
# endif
# if defined(__EXT_XOPEN_EX)
...
extern _CSTD size_t confstr(int __name, char *__buf, _CSTD size_t __len);
#if defined(__EXT_QNX)
...
extern void swab(const void *__restrict __src, void *__restrict __dest, _CSTD ssize_t __num);
...
#ifdef _STD_USING
using _CSTD size_t; using _CSTD ssize_t;
#endif /* _STD_USING */
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/deckard/BB10_2_0X/lib/c/public/unistd.h $ $REV$")
#endif
