...
#ifdef __QNXNTO__
/* pps_root should be null terminated. */
CARES_EXTERN int ares_set_pps_dev(ares_channel channel,
                                     const char* pps_dev);
CARES_EXTERN int ares_set_pps_root(ares_channel channel,
                                     const char* pps_root);
#endif
...
#ifdef __QNXNTO__
CARES_EXTERN int ares_ip6_ok(ares_channel channel);
#endif
