...
// I'm putting the warning here so that we don't add 2 dozen warnings to the automated build
#warning "BB10 3rd Party Library Deprecation: libpng14 (1.4.x) is deprecated. Please migrate to libpng16 (1.6.x)"
