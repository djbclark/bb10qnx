...
/*
 Define remappings to work around name conflicts between libasound and alsa
 */
typedef uint8_t u_int8_t;
typedef uint16_t u_int16_t;
typedef uint32_t u_int32_t;
typedef uint64_t u_int64_t;
#define snd_pcm_open snd_pcm_open_alsa
#define snd_pcm_close snd_pcm_close_alsa
#define snd_pcm_info snd_pcm_info_alsa
#define snd_pcm_link snd_pcm_link_alsa
#define snd_pcm_unlink snd_pcm_unlink_alsa
#define snd_pcm_format_signed snd_pcm_format_signed_alsa
#define snd_pcm_format_unsigned snd_pcm_format_unsigned_alsa
#define snd_pcm_format_linear snd_pcm_format_linear_alsa
#define snd_pcm_format_little_endian snd_pcm_format_little_endian_alsa
#define snd_pcm_format_big_endian snd_pcm_format_big_endian_alsa
#define snd_pcm_format_width snd_pcm_format_width_alsa
#define snd_pcm_build_linear_format snd_pcm_build_linear_format_alsa
#define snd_pcm_format_size snd_pcm_format_size_alsa
#define snd_pcm_set_chmap snd_pcm_set_chmap_alsa
#define snd_pcm_get_chmap snd_pcm_get_chmap_alsa
#define snd_pcm_query_chmaps snd_pcm_query_chmap_alsa
#define snd_pcm_free_chmaps snd_pcm_free_chmaps_alsa
#ifdef __cplusplus
extern "C" {
#endif
