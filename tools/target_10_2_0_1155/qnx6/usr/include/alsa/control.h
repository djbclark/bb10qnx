...
#define snd_card_get_name snd_card_get_name_alsa
#define snd_card_get_longname snd_card_get_longname_alsa
#define snd_ctl_open snd_ctl_open_alsa
#define snd_ctl_close snd_ctl_close_alsa
#define snd_ctl_pcm_info snd_ctl_pcm_info_alsa
