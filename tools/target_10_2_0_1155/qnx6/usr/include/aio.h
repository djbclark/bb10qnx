...
#ifdef __EXT_LF64SRC
extern int aio_cancel64(int __fd, struct aiocb64 *__aiocbp) __ALIASATTR("aio_cancel");
extern int aio_error64(__const struct aiocb64 *__aiocbp) __ALIASATTR("aio_error");
extern int aio_fsync64(int __operation, struct aiocb64 *__aiocbp) __ALIASATTR("aio_fsync");
extern int aio_read64(struct aiocb64 *__aiocbp) __ALIASOFF("aio_read");
extern ssize_t aio_return64(struct aiocb64 *__aiocpb) __ALIASATTR("aio_return");
extern int aio_suspend64(__const struct aiocb64 *__const __list[], int __nent,	__const struct timespec *__timeout) __ALIASATTR("aio_suspend");
extern int aio_write64(struct aiocb64 *__aiocpb) __ALIASOFF("aio_write");
extern int lio_listio64(int __mode, struct aiocb64 *__restrict __const __list[], int __nent, struct sigevent *__restrict __sig) __ALIASOFF("aio_listio");

/*
 * These 64 bits functions does not touch the "aio_offset" member,
 * we map them back to their 32 bits counterpart.
 */
#ifndef __ALIAS_ATTRIBUTE	/* __ALIASATTR handled this already */
...
#error ALIAS not configured for compiler: aio_read,aio_write,lio_listio
#endif
#endif
...
extern int lio_listio(int __mode, struct aiocb *_Restrict __const __list[], int __nent, struct sigevent *__restrict __sig) __ALIAS64("lio_listio64");
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/deckard/BB10_2_0X/lib/c/public/aio.h $ $REV$")
#endif
