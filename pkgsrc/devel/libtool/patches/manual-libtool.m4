...
@@ -3289,12 +3316,19 @@ linux* | k*bsd*-gnu | kopensolaris*-gnu)
...
+      _LT_TAGVAR(hardcode_shlibpath_var, $1)=no
     ...
     openbsd*)
@@ -5819,9 +5925,7 @@ m4_defun([_LT_LANG_CXX_CONFIG],
